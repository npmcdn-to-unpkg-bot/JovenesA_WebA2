    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await UserManager.SendEmailAsync(user.Id, "Reset Password", "Please reset your Jovenes Adelante website password by clicking <a href=\"" + callbackUrl + "\">here</a>. If you continue to have problems please contact our office -- 415 150 0030.");

...
export class ProfileComponent implements OnInit {
 ...
 ngOnInit() {
        ...
        //this.myLogger.log(this.routeParams.get('adminId'));
        let adminId: number  = 1216; //Number(this.routeParams.get('adminId'));
        this.myLogger.log('adminId' + adminId);
        this.sqlResource.getAdmin(adminId)
          .subscribe(
